...
class LessonContentManager {
  ...
  async _loadLessonContent(lessonId, locale = 'zh-TW') {
    ...
    try {
      ...
      // 統一尋找可能的匯出鍵
      const candidates = [
        'default','lessonContent','l21Content','l22Content','l23Content','l24Content','l25Content','l26Content','l27Content','l28Content','l29Content','l210Content','l211Content','l212Content','l31Content','l32Content','l33Content','l34Content','l35Content','l36Content','l37Content','l38Content','l39Content','l310Content','l311Part1Content','l311Part2Content','l312Content','l313Part1Content','l313Part2Content','l314Content','l3gtcContent','l410Content','l411Content','l412Content','l413Content'
      ]
...
export const lessonModuleLoaders = {
  ...
  'l2-12': () => import('./lessons/l2-12.js'), // Graves：波爾多最古老的身世
  // Level 3 (現存模組)
