...
export const l46Content = [
  ..._l46Base,
  {
    type: 'quiz',
    title: '模組診斷測驗 — 商業管理與法規（B4M2）',
    questions: [
      {
        id: 1,
        question: '酒莊新建客製化發酵槽屬於財務報表中的哪種資產分類？',
        options: [
          '流動資產（Current Assets）',
          '資本性支出（CAPEX）轉列的固定資產（PP&E）',
          '無形資產（Intangible Assets）',
          '存貨（Inventory）'
        ],
        correct: 1,
        explanation: '資本性支出（CAPEX）用於購買或改進固定資產（PP&E），支出金額資本化後按年限折舊。相對地，日常維護費用屬於營業費用（OPEX），直接於損益表列支。'
      },
      {
        id: 2,
        question: '在成本結構分析中，「邊際貢獻率」（Contribution Margin Ratio）的計算公式是？',
        options: [
          '（售價 − 單位變動成本）÷ 售價 × 100%',
          '（售價 − 固定成本）÷ 售價 × 100%',
          '毛利潤 ÷ 銷售收入 × 100%',
        ...
        correct: 0,
        explanation: '邊際貢獻率 = 邊際貢獻 ÷ 售價 = （售價 − 單位變動成本）÷ 售價。例：售價 €50，單位變動成本 €20，邊際貢獻率 = €30 ÷ €50 = 60%。高邊際貢獻率意味著每增加一單位銷售，對回收固定成本的貢獻更大。'
      },
      {
        id: 3,
        question: '波爾多 Grand Cru Classé en 1855 的評級主要依據哪項原則，且此評級共被正式修訂幾次？',
        options: [
          '依據土壤科學分析，修訂 5 次',
          '主要依據歷史售價與聲譽，自 1855 年至今正式修訂 1 次（1973 年 Mouton Rothschild 晉升一級）',
          '依據每年的評分排名，每 10 年修訂一次',
          '依據產量大小，從未被修訂'
        ],
        correct: 1,
        explanation: '1855 年分級依據波爾多商會對酒莊歷史售價和聲譽的評估，共列 61 個酒莊。自建立以來正式修訂僅 1 次：1973 年 Mouton Rothschild 由二級晉升一級（至今唯一案例）。'
      },
      {
        id: 4,
        question: '酒莊想在法國市場推出新酒款，若不符合任何現有 AOC 標準，應如何申報？',
        options: [
          '完全無法在法國市場銷售',
          '以「Vin de France」（法國餐酒）申報，可靈活使用品種和年份標示',
          '申請新的 AOC 認證，通常在 6 個月內完成',
          '必須出口後再進口，繞過 AOC 規定'
        ],
        correct: 1,
        explanation: 'Vin de France 是法國最基礎的地理標誌等級，允許使用任何法定品種、任意混釀，且可標示品種和年份（AOC 規定外的彈性）。許多創新釀造師選擇降等為 VdF 以獲得釀造自由度，但代價是失去地理標誌品牌溢價。'
      },
      {
        id: 5,
        question: '在品牌保護策略中，「商標蠶食」（Trademark Dilution）指的是什麼情況？',
        options: [
          '競爭者仿冒酒標設計，消費者混淆購買',
          '即使無競爭關係，知名商標因第三方不當使用而淡化其獨特性或聲譽損害',
          '酒莊商標過期未續展，被他人搶先註冊',
          '多個酒莊共同使用同一產區名稱造成混淆'
        ],
        correct: 1,
        explanation: '商標蠶食（淡化）適用於馳名商標：即使用於不相關商品/服務，若因廣泛使用削弱商標獨特性（淡化）或損害商標聲譽（污損），仍可能構成侵權。波爾多頂級酒莊需在全球多個司法管轄區積極主張商標權利。'
      },
      {
        id: 6,
        question: '在設計酒莊「顧客終身價值」（CLV）提升策略時，下列哪種措施的 ROI 通常最高？',
        options: [
          '大規模投放社群媒體廣告吸引新顧客',
          '建立高黏性的酒莊會員訂閱制（含優先購買權、私人品酒活動等）',
          '降低售價以提高銷售量',
          '在旅遊景點設立快閃零售點'
        ],
        correct: 1,
        explanation: '行銷研究顯示，保留現有顧客的成本約為開發新顧客的 1/5。會員訂閱制（分配制、En Primeur 優先權、私人活動）能顯著提升購買頻率、平均客單價和推薦率，是提升 CLV 和 ROI 最有效的策略。'
      },
      {
        id: 7,
        question: '歐盟即將生效的葡萄酒數位標示規範（e-label）要求強制顯示哪類資訊？',
        options: [
          '酒莊創辦人的個人履歷',
          '原料成分（配料清單）、營養資訊（熱量/糖/酸等）及回收標誌',
          '所有使用農藥的完整清單',
          '橡木桶供應商和陳年時長'
        ],
        correct: 1,
        explanation: '歐盟 Regulation 2021/2117 要求所有在歐盟市場銷售的葡萄酒必須標示：原料成分列表、營養聲明（能量值、碳水化合物等）、回收符號，可透過 QR code 呈現部分資訊。這是波爾多出口商的重要合規要求。'
      },
      {
        id: 8,
        question: '波爾多酒莊在執行「敏感度分析」（Sensitivity Analysis）時，下列哪種情境對頂級列級莊的淨利影響最大？',
        options: [
          '葡萄園用水成本上漲 20%',
          'En Primeur 釋出價格下跌 15%（對應年份評分低於預期）',
          '運輸物流費用上漲 10%',
          '葡萄園勞工最低工資上調 5%'
        ],
        correct: 1,
        explanation: '對頂級列級莊而言，產品售價是收入最大的單一驅動因素，且售價彈性受年份評分影響極大。15% 的價格下跌可能直接導致整體淨利下降 30-40%（視固定成本比例）；相比之下，水電、運輸、勞工成本在總成本中占比較低。'
      },
      {
        id: 9,
        question: '「DRC（Domaine de la Romanée-Conti）模式」與「波爾多大酒莊模式」在品牌策略上最根本的差異是？',
        options: [
          'DRC 採用有機農業，波爾多普遍採用慣行農業',
          'DRC 嚴格控制總產量（全球稀缺性策略），波爾多以規模、知名度和等級制度建立品牌溢價',
          'DRC 只在法國本地銷售，波爾多專注出口市場',
          'DRC 採用 En Primeur 制度，波爾多則不採用'
        ],
        correct: 1,
        explanation: 'DRC 的品牌策略核心是極端稀缺性：Romanée-Conti 每年僅 5,000-6,000 瓶，通過嚴格配額制控制全球流通量。波爾多頂級酒莊則以 AOC 等級制度、歷史品牌聲譽、期酒制度維持高溢價，產量相對更大。'
      },
      {
        id: 10,
        question: '酒莊計劃進入中國市場，負責核准進口葡萄酒標示合規的主要機構是？',
        options: [
          '商務部（MOFCOM）',
          '海關總署（GACC）與市場監督管理總局（SAMR）聯合監管',
          '農業農村部（MARA）',
          '國家衛生健康委員會（NHC）'
        ],
        correct: 1,
        explanation: '中國進口葡萄酒合規涉及多部門：GACC（海關總署）負責進口申報和進境檢驗；SAMR（市場監督管理總局）負責標示合規審查（依據 GB 10344 食品標示通則）。需確保中文標示、酒精度標示、生產企業信息等符合要求。'
      }
    ],
    passingScore: 70,
    timeLimit: 420
