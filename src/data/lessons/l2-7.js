...
export const lessonContent = [
  ...
  // ========== 3. 風土：高原 vs 坡地 =========
  {
    ...
    content: `<div class="saint-emilion-style">
      ...
      <div class="lesson-image" style="margin: 20px 0; text-align: center;"><img src="/images/L2-7/01 Saint-Emilion-Three-Terroir-Zones.svg" alt="Saint-Émilion 三大風土區" style="max-width: 100%; height: auto; border-radius: 8px;" /></div>
