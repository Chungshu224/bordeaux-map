    ...
    questions: [
      {
        ...
        correct: 3,
        explanation: '110R 對石灰與旱害耐受度高，活力足以維持產量；3309C 和 101-14 對高石灰土壤耐受力弱，易出現失綠症。'
      },
      {
        id: 2,
        ...
        correct: 1,
        explanation: 'XGBoost 等機器學習模型能整合多變量（溫度、蒸發量、前期水勢），預測短期水勢非線性變化，優於單一指標判斷。'
      },
      {
        id: 3,
        ...
        correct: 2,
        explanation: '調配矩陣整理各批次的優勢（如香氣複雜度、單寧結構）與限制（如過高酸度），協助決定最佳混調比例與角色定位。'
      },
      {
        id: 4,
        question: '在坡地葡萄園中，影響排水效率最關鍵的地形指標是哪一項？',
        options: ['海拔高度', '坡向（Aspect）', '地形濕度指數（TWI）', '年均日照時數'],
        correct: 2,
        explanation: '地形濕度指數（TWI）整合坡度與集水面積，直接反映特定地點的積水傾向，是排水效率最敏感的地形指標。'
      },
      {
        id: 5,
        question: '微地塊分析中，高解析度（>1m）空間遙感資料主要用於識別哪類差異？',
        options: ['品種 DNA 鑑定', '樹冠層活力與水分壓力差異', '桶陳時間差異', '裝瓶時間差異'],
        correct: 1,
        explanation: 'NDVI、NDWI 等高解析度遙感指數可識別樹冠活力不均、局部水分脅迫地點，直接指導微地塊管理決策。'
      },
      {
        id: 6,
        question: '碰到特定微地塊單寧偏青澀、成熟度落後，但其他地塊已達最佳成熟，最合適的採收策略是？',
        options: ['全部一起採，混入釀造以稀釋', '推遲所有地塊採收等待成熟', '分批採收，此地塊延後 7-10 天單獨釀造', '丟棄此地塊，不釀入正牌'],
        correct: 2,
        explanation: '微地塊分離採收與釀造是現代精品酒莊的核心策略；分批採收讓每個地塊在最佳成熟度入桶，最大化品質表現。'
      },
      {
        id: 7,
        question: '土壤有效水容量（AWC）偏低（＜80 mm）的地塊，對赤霞珠成熟曲線最可能產生何種影響？',
        options: ['延長生長季，增加花青素積累', '造成提前水分脅迫，加速成熟但酸度下降較快', '完全抑制果實發育', '完全不影響，赤霞珠耐旱性強'],
        correct: 1,
        explanation: 'AWC 低的地塊在乾旱期間水分脅迫出現早，葡萄藤提前關閉氣孔，光合作用效率下降，果實糖分濃縮但蘋果酸分解加速，成熟曲線更陡、窗口更窄。'
      },
      {
        id: 8,
        question: '在波爾多左岸，傳統上認為最適合赤霞珠種植的土壤是哪一種？其主要成因為何？',
        options: ['重黏土；保水性強、養分豐富', '礫石砂礫土（Gravel/Gravelly soil）；排水佳、日間吸熱夜間輻射，促進成熟', '腐植土（Humus）；有機質高，促進根系生長', '純砂土；根系擴展快'],
        correct: 1,
        explanation: '梅多克的礫石砂礫土層（如 Pauillac 的粗礫石）排水極佳、日間蓄熱、夜間輻射熱能，讓赤霞珠達到完整成熟；黏土保水過多反而不利赤霞珠表現（梅洛更適合右岸黏土）。'
      }
    ],
    passingScore: 70,
    timeLimit: 300
