...

  {
    ...
    componentProps: {
      ...
      items: [
        ...
        {
          question: '干白酒木桶發酵中，「bâtonnage」（攪桶）技術的主要目的是？',
          options: ['去除沉澱，讓酒液更清澈', '攪散酒泥增加酒體豐厚度與乳脂感', '降低酸度', '加速木桶風味萃取'],
          correct: 1,
          explanation: 'Bâtonnage（攪桶）定期攪動橡木桶底的死亡酵母細胞（酒泥/lees），使其均勻分散，釋放多醣和氨基酸，增加白酒的豐厚度、口感複雜性，是優質波爾多白酒的關鍵技術。'
        },
        {
          question: '「微氧化」（Micro-oxygenation）技術在波爾多釀酒中的主要應用是？',
          options: ['強制氧化讓酒快速熟成，加速上市', '可控地讓微量氧氣接觸葡萄酒，柔化單寧並穩定顏色', '增加酒精度', '去除揮發酸'],
          correct: 1,
          explanation: '微氧化技術透過可控方式讓極微量氧氣接觸葡萄酒，模擬橡木桶的緩慢透氧作用，促進花青素和單寧聚合，柔化口感、穩定顏色，可在不使用橡木桶的情況下達到類似效果。'
        },
        {
          question: '氣候炎熱乾燥的年份（如2015、2018）對波爾多Cabernet Sauvignon通常帶來什麼影響？',
          options: ['品質下降，葡萄未成熟', '果皮更厚、多酚更濃縮，風格更豐滿強勁', '產量大幅增加', '導致提早爛果'],
          correct: 1,
          explanation: '適度乾旱迫使葡萄藤根部向深處延伸，果粒縮小使果皮比例增加，多酚（花青素、單寧）更濃縮；配合良好成熟度，往往產出單寧豐滿、陳年力強的優質年份酒。'
        },
        {
          question: '現代土壤科學研究中，哪個「風土因素」對葡萄酒風味的影響開始受到重視？',
          options: ['土壤礦物質直接轉化為酒的礦物感', '土壤微生物群落影響葡萄藤健康和根系代謝', '月亮週期的引力', '土壤顏色決定酒色深淺'],
          correct: 1,
          explanation: '現代土壤微生物學研究顯示，土壤中細菌、真菌群落（微生物組）影響葡萄藤養分吸收和抗病能力。有機和生物動力農法特別注重維護土壤生態健康，被認為是風土多樣性的關鍵。'
        },
        {
          question: '波爾多期酒（En Primeur）每年的主要交易時間點是？',
          options: ['每年採收後約6個月的春季（約4月）', '每年12月聖誕節前', '葡萄酒裝瓶後立即在市場販售', '採收前的夏末'],
          correct: 0,
          explanation: 'En Primeur的年度Campaign通常在採收後約6個月的春季（約4月）進行，酒莊開放試飲、國際評論家打分，買家在酒未裝瓶前預購，裝瓶交貨需等待約18-24個月。'
        },
        {
          question: '氣候變遷使波爾多的葡萄採收期相比1980年代大約提前了多少？',
          options: ['約3天', '約2-3週', '約2個月', '幾乎沒有變化'],
          correct: 1,
          explanation: '研究資料顯示，波爾多的採收期比1980年代提前了約2-3週（15-20天），是氣候變化最顯著的實際影響之一，並導致酒款風格向更濃郁、高酒精的方向演變。'
        },
        {
          question: '部分波爾多酒莊開始提早採收（比完全成熟更早），主要是為了？',
          options: ['獲得更多糖分，釀造更甜的酒', '保留天然酸度，避免酒精度過高', '獲得更多單寧', '避免秋季降雨'],
          correct: 1,
          explanation: '隨著氣溫升高，若等多酚完全成熟才採收，糖分可能已過高，導致酒精度超過14.5%甚至更高。提早採收有助於保留天然酸度和新鮮感，維持酒款的平衡與優雅度。'
        },
        {
          question: '「逆滲透」（Reverse Osmosis）技術在波爾多現代釀酒中的主要用途是？',
          options: ['增加酒款的礦物感', '去除多餘水分（雨季稀釋）或降低過高的酒精度', '加速發酵過程', '去除氧化風味'],
          correct: 1,
          explanation: '逆滲透技術可在兩種情況下使用：雨後果實被稀釋時去除多餘水分（濃縮果汁），或在酒精度過高時去除部分酒精以恢復平衡。這是現代釀酒技術干預的爭議性話題之一。'
        },
        {
          question: '以Robert Parker為代表的百分制評分，在波爾多葡萄酒市場的主要影響是？',
          options: ['對波爾多市場幾乎沒有影響', '高分（尤其95+）大幅推動酒款價格上漲，改變全球採購決策', '只在美國市場有效', '使波爾多酒款的整體價格下降'],
          correct: 1,
          explanation: 'Robert Parker的百分制評分（尤其95+分）可使酒款價格一夜之間翻數倍。其偏好成熟、濃郁、低酸的「國際化風格」，曾深刻影響1980-2000年代波爾多的釀酒哲學，但現在消費者口味更多元。'
        },
        {
          question: '「垂直品飲」（Vertical Tasting）與「水平品飲」（Horizontal Tasting）的定義分別是？',
          options: [
            '垂直＝多莊同一年份，水平＝同莊多個年份',
            '垂直＝同一酒莊多個年份，水平＝同一年份多個酒莊或產區',
            '兩者完全相同，只是名稱不同',
            '垂直只適用於白酒，水平只適用於紅酒'
          ],
          correct: 1,
          explanation: '垂直品飲（Vertical）是同一酒莊連續多個年份的比較，用於了解年份差異和陳年演變；水平品飲（Horizontal）是同一年份多個不同酒莊或產區的比較，用於了解產區風格差異。'
        }
      ]
    },
    presenterNotes: [
