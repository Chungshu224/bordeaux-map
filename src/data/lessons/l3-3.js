  ...
  // 課程簡介
  {
    ...
    content: `
      <div class="intro-content">
        ...
        <div class="lesson-image" style="margin: 20px 0; text-align: center;"><img src="/images/L3-3/01%20波爾多極端年份歷史與氣候風險.svg" alt="波爾多歷史極端年份時間軸與氣候風險應對策略" style="max-width: 100%; height: auto; border-radius: 8px;" /></div>
