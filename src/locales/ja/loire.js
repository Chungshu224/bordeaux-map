...
export default {
  ...
  lessons: {
    ...
    'lo-l1-5': { title: 'ロワール渓谷 赤ブドウ品種全解', duration: 20 },
    'lo-l1-6': { title: '六大サブリージョン深掘り探索', duration: 18 },
    'lo-l1-7': { title: 'ロワール渓谷 ワインスタイルと種類全覧', duration: 25 },
    'lo-l1-8': { title: 'テイスティング技術と Level 1 総合評価', duration: 30 },
