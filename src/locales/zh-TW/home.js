...
export default {
  ...
  faq: {
    ...
    items: [
      ...
      { q: '波爾多完整版包含哪些內容？', a: 'NT$249/月（或 NT$1,990/年）可解鎖波爾多 Level 1–4 全部 43 堂課程、4 種互動練習遊戲、地質岩層與氣候熱力圖進階圖層，以及品飲筆記本（無限則記錄）。' },
      { q: '課程等級如何解鎖？', a: 'Level 1 开放所有學員直接進入。Level 2、3、4 需依序完成前一等級的「綣合評量」才能解鎖，確保遠學相對應層級的基礎。' },
      { q: '訂閱後如何取消？', a: '目前採綠界（ECPay）一次性付款。若需調整方案或取消後續續購，請聯絡我們客服協助處理。' },
      { q: '月繳與年繳有什麼差別？', a: '月繳 NT$249 彈性較高；年繳 NT$1,990（相當於 NT$166/月），相比月繳年省 NT$998，適合備考命名或長期深度學習。' },
      { q: '我不會品酒，可以學嗎？', a: '當然！Level 1 從最基礎的葡萄酒知識開始，循序漸進，完全不需要任何先備知識。' },
      { q: '多產區方案何時上線？', a: '多產區方案（NT$449/月）預計近期推出，上線後可自選三大世界產區。先訂閱波爾多完整版的學員，上線時可隨時升級。' },
