...
export default {
  ...
  faq: {
    sectionTitle: '常見問題',
    items: [
      { q: '免費方案包含哪些內容？', a: '免費方案永久有效，包含波爾多 Level 1 全部課程（8 堂）及互動地圖瀏覽，不需信用卡。第二級以上課程及練習遊戲需升級訂閱。' },
      ...
      { q: '課程等級如何解鎖？', a: 'Level 1 開放所有學員直接進入。Level 2、3、4 需依序完成前一等級的「綜合評量」才能解鎖，確保該學員具備對應層級的基礎。' },
  ...
  modal: {
    bordeaux: {
      ...
      comparePremium: '多產區方案（即將）<br><span class="cc-price">NT$ {price}/月</span>',
      btnFree: '免費開始體驗',
      btnBasicPrice: '訂閱波爾多完整版 NT${price}/月',
      btnPremiumPrice: '多產區方案 NT${price}/月',
      levels: {
      ...
      compareRows: [
        ...
        { feature: '地質圖層',         free: false, basic: true,  premium: true },
        { feature: '氣候熱力圖層',     free: false, basic: true,  premium: true },
        { feature: '知名酒莊地圖標記', free: false, basic: true,  premium: true },
        ...
        { feature: '品飲筆記本',       free: false, basic: true,  premium: true },
        { feature: '學員論壇',         free: true,  basic: true,  premium: true },
        { feature: '多產區課程（3產區可選）', free: false, basic: false, premium: true },
      ],
    },
