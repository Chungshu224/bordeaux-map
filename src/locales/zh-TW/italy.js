...
export default {
  ...
  // 課程投影片互動元件（地圖、Super Tuscan 進化史、姊妹 DOCG 對比）
  slides: {
    mapCommon: {
    ...
    sicilyMap: {
      defaultTitle: '🗺️ Sicily 重要產區互動地圖',
      legend: {
        s: '頂級 — Etna 火山產區',
        a: '重要 DOCG / 歷史 DOC',
        b: '特色 DOC',
      ...
      zones: {
        etna: {
          ...
          grape: '紅：Nerello Mascalese 80%+；白：Carricante 60%+',
          altitude: '300-1,200m，歐洲種植海拔最高的產區之一',
          soil: '深色鬆散的火山砂土覆蓋熔岩底土，能抵抗根瘤蚜，保有許多未嫁接老藤',
          style: '優雅高酸礦物感，133 個 Contrada 分區如 Burgundy Climat',
        ...
        cerasuolo: {
          ...
          grape: 'Nero d’Avola 50-70% + Frappato 30-50%，黃金混釀',
          certification: '1973 年 DOC，2005 年升格 DOCG，最低 13% 酒精，另有 Classico 子產區',
          style: '中等酒體、成熟櫻桃紅色（Cerasuolo 意為「櫻桃色」）、均衡優雅',
        ...
        marsala: {
          name: 'Marsala DOC',
          shortName: 'Marsala',
          tierLabel: '⭐ 歷史 DOC — 1969 年成立',
          grape: '白：Grillo / Catarratto / Inzolia / Damaschino；Rubino 款：Perricone（Pignatello）/ Nero d’Avola / Nerello Mascalese',
          method: '加入葡萄烈酒或酒精加烈；Fine 與 Superiore 可再加 concia（mosto cotto、sifone、mosto concentrato），Vergine 不可',
          tiers: 'Fine（1年）→ Superiore（2年）→ Superiore Riserva（4年）→ Vergine（5年）→ Vergine Riserva／Stravecchio（10年）',
          sweetness: 'Secco（干型）/ Semisecco / Dolce（甜型）',
        ...
        pantelleria: {
          ...
          method: 'Passito：8 月先採一批 Zibibbo 曬乾，再加入其餘葡萄的葡萄汁中發酵',
          wines: 'Passito di Pantelleria、Moscato di Pantelleria（不風乾）等，2013 年統整為 Pantelleria DOC',
          style: '濃郁杏桃、蜂蜜、柑橘蜜餞、琥珀色，甜而不膩',
        ...
        noto: {
          ...
          grape: '以 Nero d’Avola 為主，Sicily 最重要的紅葡萄',
          style: '顏色深、酒體飽滿、單寧柔順、酒精高，黑莓、巧克力、甜香料',
          soil: '石灰岩白土（Calcareo），炎熱乾燥，陽光充足',
          nearby: 'Eloro DOC 與其 Pachino 子產區（最低 80% Nero d’Avola）',
