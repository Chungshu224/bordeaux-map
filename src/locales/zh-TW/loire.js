...
export default {
  ...
  lessons: {
    ...
    'lo-l1-5': { title: '羅亞爾河谷紅葡萄品種全解', duration: 20 },
    'lo-l1-6': { title: '六大子產區深度探索', duration: 18 },
    'lo-l1-7': { title: '羅亞爾河谷酒款類型與風格全覽', duration: 25 },
    'lo-l1-8': { title: '品飲技巧與 Level 1 綜合評量', duration: 30 },
