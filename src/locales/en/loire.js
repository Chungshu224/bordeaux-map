...
export default {
  ...
  modules: {
    ...
    LO2M0: 'Level 2 Introduction: Red Grape Varieties',
  ...
  lessons: {
    ...
    'lo-l1-5': { title: 'Loire Valley Red Grape Varieties in Full', duration: 20 },
    'lo-l1-6': { title: 'Six Sub-Regions Deep Dive', duration: 18 },
    'lo-l1-7': { title: 'Loire Valley Wine Styles & Types', duration: 25 },
    'lo-l1-8': { title: 'Tasting Techniques & Level 1 Final Exam', duration: 30 },
