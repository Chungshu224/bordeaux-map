...
import CourseManager from './course/CourseManager.vue'
import BourgogneRegionSelector from './BourgogneRegionSelector.vue'
import BourgogneRegionMap from './BourgogneRegionMap.vue'
