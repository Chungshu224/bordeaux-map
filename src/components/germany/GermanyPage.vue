<script setup>
import { ref } from 'vue'
import GermanyRegionSelector from './map/GermanyRegionSelector.vue'
import GermanyMapSection from './map/GermanyMapSection.vue'
import GermanyCourseManager from './course/GermanyCourseManager.vue'
