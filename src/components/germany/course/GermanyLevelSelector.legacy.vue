    ...
    <div class="main-container">
      ...
      <section class="quick-nav-section">
        <div class="quick-nav-grid">
          <button class="nav-card games coming-soon-card" @click="alert('「互動練習」功能即將推出，敬請期待！')">
          ...
          <button class="nav-card achievements coming-soon-card" @click="alert('「成就系統」功能即將推出，敬請期待！')">
            <span class="cs-badge">即將推出</span>
            <span class="nav-icon">🏆</span>
          ...
          <button class="nav-card notebook coming-soon-card" @click="alert('「品飲筆記」功能即將推出，敬請期待！')">
            <span class="cs-badge">即將推出</span>
            <span class="nav-icon">📔</span>
