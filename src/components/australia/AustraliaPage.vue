<script setup>
import { ref } from 'vue'
import AustraliaCourseManager   from './course/AustraliaCourseManager.vue'
import AustraliaRegionSelector  from './map/AustraliaRegionSelector.vue'
import AustraliaMapSection      from './map/AustraliaMapSection.vue'
