...
const CLIMATE_INDICATORS = [
  { id: 'temp', icon: '🌡', label: '夏季均溫', unit: '°C', lowLabel: '涼', highLabel: '熱',
    footnote: '指標：12–2 月日均溫平均值（南半球夏季，12 月併入次年）| 基準：1981–2010', dataKey: 'temps', baselineKey: 'baseline' },
  { id: 'sun',  icon: '☀️', label: '日照時數',  unit: 'h',  lowLabel: '少', highLabel: '多',
    footnote: '指標：12–2 月日照時數總和（小時，南半球夏季，12 月併入次年）| 基準：1981–2010', dataKey: 'sun', baselineKey: 'baselineSun' },
  { id: 'rain', icon: '🌧', label: '夏季降雨', unit: 'mm', lowLabel: '乾', highLabel: '濕',
    footnote: '指標：12–2 月降雨量總和（毫米，南半球夏季，12 月併入次年）| 基準：1981–2010', dataKey: 'rain', baselineKey: 'baselineRain' },
]
