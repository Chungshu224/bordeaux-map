...
.game-card        { background: linear-gradient(135deg, #1a3a6b, #0d2b50); color: #fff; }
.achievement-card { background: linear-gradient(135deg, #c8a951, #d4b86a); color: #00274e; }
.progress-card    { background: linear-gradient(135deg, #27ae60, #1e8449); color: #fff; }
