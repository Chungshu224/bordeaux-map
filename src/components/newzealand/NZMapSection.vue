...
:global(.nz-geology-popup-wrap .mapboxgl-popup-close-button) {
...
:global(.nz-geo-val) { color: #fff; font-size: 13px; }
:global(.nz-geo-desc) { font-size: 12px; line-height: 1.5; color: #e8efe8; padding: 6px 14px; }
