...
@media (max-width: 640px) {
  /* 成就 modal 改為底部抽屜 */
  .achievement-modal-overlay { padding: 0; align-items: flex-end; }
  .achievement-modal { border-radius: 20px 20px 0 0; max-height: 92vh; }
  .am-header { border-radius: 0; padding: 0.75rem 1rem; }
}
</style>
