...
.aoc-search { width: 100%; padding: 8px 12px; border-radius: 4px; border: 1px solid #ccc; margin-bottom: 15px; font-size: 0.9rem; }
...
.region-header .group-name { font-size: 1rem; font-weight: 500; }
.group-icon { font-size: 0.7rem; margin-right: 8px; width: 10px; }
.island-content { margin-left: 10px; }
.region-group { margin-left: 10px; }
.region-content { margin-left: 20px; }
.aoc-item { display: flex; align-items: center; padding: 6px 8px; margin: 2px 0; border-radius: 4px; cursor: pointer; font-size: 0.9rem; }
