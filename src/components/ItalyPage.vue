<script setup>
import { ref } from 'vue'
import ItalyCourseManager from './italy/course/ItalyCourseManager.vue'
import ItalyRegionSelector from './italy/map/ItalyRegionSelector.vue'
import ItalyMapSection from './italy/map/ItalyMapSection.vue'
