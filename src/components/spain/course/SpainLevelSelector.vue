...
const levels = [
  {
    ...
    status: 'active',
    desc: '認識西班牙產區地理、分級制度（DO/DOCa/VP）、主要葡萄品種與陳年規定',
    topics: ['地理概況', '分級制度', 'Tempranillo', 'Rioja 入門'],
    lessons: '8 個單元・約 2 小時',
  },
  {
    key:   'level2',
    label: 'Level 2',
    ...
    status: 'coming',
    desc: '深入探索 Ribera del Duero、Rías Baixas、Priorat、Jerez Sherry 等頂級產區',
    topics: ['Ribera del Duero', 'Rías Baixas', 'Priorat', 'Sherry'],
    lessons: '12 個單元・約 3 小時',
  },
  {
    key:   'level3',
    label: 'Level 3',
    ...
    status: 'coming',
    desc: '橡木桶陳年哲學、Cava 傳統法氣泡酒、Sherry 索雷拉系統與甜型酒',
    topics: ['Crianza/Reserva', 'Cava', 'Sherry 熟成', '加強酒'],
    lessons: '10 個單元・約 2.5 小時',
  },
  {
    key:   'level4',
    label: 'Level 4',
    ...
    status: 'coming',
    desc: '盲飲技巧、年份評比、頂級酒莊解析，成為西班牙葡萄酒達人',
    topics: ['盲飲', '頂級酒莊', '年份分析', '品飲筆記'],
    lessons: '8 個單元・約 2 小時',
  },
]
