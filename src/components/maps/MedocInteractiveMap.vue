...
const medocChateaux = [
  ...
  { name: 'Château Rauzan-Ségla', coords: [-0.67484, 45.03543], rank: '2', aoc: 'Margaux', description: 'Margaux 頂尖二級酒莊', image: '/images/chateaux/LeftBank/Medoc/rauzan_segla.jpg' },
  { name: 'Château Rauzan-Gassies', coords: [-0.67497, 45.03669], rank: '2', aoc: 'Margaux', description: '與Rauzan-Ségla同源，歷史悠久', image: '/images/chateaux/LeftBank/Medoc/rauzan_gassies.jpg' },
  ...
  { name: 'Château Durfort-Vivens', coords: [-0.67498, 45.03990], rank: '2', aoc: 'Margaux', description: '傳統風格的 Margaux' },
  ...
  { name: 'Château Malescot Saint-Exupéry', coords: [-0.6736, 45.0414], rank: '3', aoc: 'Margaux', description: '濃郁複雜的風格' },
  { name: 'Château Cantenac-Brown', coords: [-0.67923, 45.02780], rank: '3', aoc: 'Margaux', description: '強勁有力的風格', image: '/images/chateaux/LeftBank/Medoc/cantenac_brown.jpg' },
  { name: 'Château Boyd-Cantenac', coords: [-0.6560, 45.0228], rank: '3', aoc: 'Margaux', description: '經典 Margaux 風格', image: '/images/chateaux/LeftBank/Medoc/Boyd-Cantenac.jpg' },
  { name: 'Château Giscours', coords: [-0.64605, 45.0087], rank: '3', aoc: 'Margaux', description: '規模大品質穩定', image: '/images/chateaux/LeftBank/Medoc/Giscours.jpg' },
  { name: 'Château Desmirail', coords: [-0.65397, 45.02852], rank: '3', aoc: 'Margaux', description: '復興中的三級莊', image: '/images/chateaux/LeftBank/Medoc/desmirail.jpg' },
  { name: 'Château Ferrière', coords: [-0.6778, 45.0433], rank: '3', aoc: 'Margaux', description: '小型精品酒莊，風格精緻', image: '/images/chateaux/LeftBank/Medoc/ferriere.jpg' },
  { name: "Château Marquis d'Alesme", coords: [-0.67702, 45.04194], rank: '3', aoc: 'Margaux', description: '小而優雅的三級莊', image: '/images/chateaux/LeftBank/Medoc/marquis_dalesme.jpg' },
  ...
  { name: 'Château Pouget', coords: [-0.6569, 45.0232], rank: '4', aoc: 'Margaux', description: '小型精品酒莊', image: '/images/chateaux/LeftBank/Medoc/Pouget.jpg' },
  { name: 'Château du Tertre', coords: [-0.68090, 45.00593], rank: '5', aoc: 'Margaux', description: '位於Arsac，風土獨特', image: '/images/chateaux/LeftBank/Medoc/du_tertre.jpg' },
  { name: 'Château Dauzac', coords: [-0.62345, 45.01936], rank: '5', aoc: 'Margaux', description: '位於Labarde，近年品質提升', image: '/images/chateaux/LeftBank/Medoc/dauzac.jpg' },
