...
const EXTRA_QUESTIONS = {
  ...
  L3M2L1: { type: 'single', question: 'Barolo MGA 系統中，「MGA」代表什麼？', options: ['A. Master Grand Appellation', 'B. Menzione Geografica Aggiuntiva（附加地理名稱）', 'C. Massimo Grado Artigianale', 'D. Metodo Geografico Avanzato'], correct: 1, explanation: 'MGA 是 Menzione Geografica Aggiuntiva 的縮寫，允許酒標上標示特定葡萄園名稱，類似勃根地的一級/特級園概念。' },
